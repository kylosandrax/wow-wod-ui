...
local timerSunderCD					= mod:NewCDTimer(8, 143494, nil, "Tank", nil, 5)
local timerExecuteCD				= mod:NewCDTimer(18, 143502, nil, "Tank", nil, 5)
...
--Kor'kron Adds
local timerEmpoweredChainHealCD		= mod:NewNextSourceTimer(6, 143473, nil, nil, nil, 4)
