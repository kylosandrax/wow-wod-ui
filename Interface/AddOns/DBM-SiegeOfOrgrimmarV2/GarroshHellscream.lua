...
local timerHellscreamsWarsongCD		= mod:NewNextTimer(42.2, 144821, nil, "Tank|Healer", nil, 5)
...
local timerPowerIronStar			= mod:NewCastTimer(16.5, 144616, nil, nil, nil, 2)
--Intermission: Realm of Y'Shaarj
...
--Stage Two: Power of Y'Shaarj
local timerWhirlingCorruptionCD		= mod:NewCDCountTimer(49.5, 144985, nil, nil, nil, 2)--One bar for both, "empowered" makes timer too long
local timerWhirlingCorruption		= mod:NewBuffActiveTimer(9, 144985, nil, false)
local timerTouchOfYShaarjCD			= mod:NewCDCountTimer(45, 145071, nil, nil, nil, 3)
local timerGrippingDespair			= mod:NewTargetTimer(15, 145183, nil, "Tank", nil, 5)
--Starge Three: MY WORLD
--Starge Four: Heroic Hidden Phase
...
local timerBombardmentCD			= mod:NewNextTimer(55, 147120, nil, nil, nil, 2)
