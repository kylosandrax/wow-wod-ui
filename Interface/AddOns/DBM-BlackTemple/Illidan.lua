...
local timerNextHuman		= mod:NewTimer(74, "TimerNextHuman", 2457, nil, nil, 6)
local timerNextDemon		= mod:NewTimer(60, "TimerNextDemon", 2457, nil, nil, 6)
...
local timerPhase4			= mod:NewTimer(30, "TimerPhase4", 2457, nil, nil, 6)
