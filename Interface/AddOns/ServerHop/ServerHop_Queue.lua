...
local function QueueFrame_OnEnter(self)
	...
	GameTooltip:AddDoubleLine(WHISPER,HOPADDON_LMB,0.25, 0.75, 0.25);
...
local function MakeQueueFrame(index)
	...
	frame:SetScript("OnClick",function(self,button,down)
		...
		elseif button == "LeftButton" then
			local id, activityID, name, comment, voiceChat, iLvl, age, numBNetFriends, numCharFriends, numGuildMates, isDelisted, leaderName = C_LFGList.GetSearchResultInfo(self.result);
