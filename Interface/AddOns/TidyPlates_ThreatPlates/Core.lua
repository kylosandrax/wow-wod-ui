...
local changelog = {
	"Made necessary changes for totem updates with patch 6.0.2.",
	"Fixed issue with nameplate coloring and custom threat colors (Ticket 60).",
	"Fixed alpha settings and scale settings for totems.",
	"",
	""
}
