...
local L = TidyPlatesHub_GetLocalizedString
	...
	--[[ 6.7 Testing
	TidyPlatesHubMenus.ArtStyles = {{ text = "Blizzard", notCheckable = 1 } ,}

	TidyPlatesHubMenus.ArtModes = {
...
TidyPlatesHubMenus.BasicTextModes = {
				{ text = L("None") },
...
TidyPlatesHubMenus.CustomTextModes = {
				{ text = L("None") },
				{ text = L("Percent Health")} ,
				{ text = L("Exact health"),},
				{ text = L("Health Deficit"),} ,
...
-----
--[[
TidyPlatesHubMenus.HealthColorModes = {
				{ text = L("Default"), notCheckable = 1 } ,
...
--]]
TidyPlatesHubMenus.WarningGlowModes = {
				{ text = L("None"), notCheckable = 1 } ,
				{ text = L("By Threat"), notCheckable = 1 } ,
				{ text = L("On Enemy Healers"), notCheckable = 1 } ,
				}
...
TidyPlatesHubMenus.TextPlateFieldModes = {
				{ text = L("None"), notCheckable = 1 } ,
				{ text = L("Percent Health"), notCheckable = 1 } ,		--
