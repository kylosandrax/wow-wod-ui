...
local timerSmolderingDevastationCD	= mod:NewNextCountTimer(90, 99052, nil, nil, nil, 2)
local timerEmberFlareCD				= mod:NewNextTimer(6, 98934, nil, nil, nil, 2)
local timerSmolderingDevastation	= mod:NewCastTimer(8, 99052, nil, nil, nil, 2)
local timerFixate					= mod:NewTargetTimer(10, 99526)
local timerWidowsKissCD				= mod:NewCDTimer(32, 99476, nil, "Tank|Healer", nil, 5)
