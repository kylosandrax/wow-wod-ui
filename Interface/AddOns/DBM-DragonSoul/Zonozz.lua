...
local timerPsychicDrainCD		= mod:NewCDTimer(20, 104322, nil, "Tank", nil, 5)--Every 20-25 seconds, variates.
local timerShadowsCD			= mod:NewCDTimer(25, 103434, nil, nil, nil, 3)--Every 25-30, variates
