...
local timerUnstableMonstrosity		= mod:NewNextTimer(60, 106372, nil, "Healer", nil, 5)
...
local timerFadingLightCD			= mod:NewNextTimer(10, 109075, nil, nil, nil, 3)
local timerGiftofLight				= mod:NewNextTimer(80, 105896, nil, "Healer", nil, 5)
local timerEssenceofDreams			= mod:NewNextTimer(155, 105900, nil, "Healer", nil, 5)
local timerSourceofMagic			= mod:NewNextTimer(215, 105903, nil, "Healer", nil, 5)
