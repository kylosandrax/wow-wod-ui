...
local timerOozesCD			= mod:NewNextTimer(90, "ej3978", nil, nil, nil, 1)
local timerOozesActive		= mod:NewTimer(7, "timerOozesActive", 16372, nil, nil, 1) -- varies (7.0~8.5)
local timerOozesReach		= mod:NewTimer(34.5, "timerOozesReach", 16372, nil, nil, 1)
...
local timerVoidBoltCD		= mod:NewNextTimer(6, 104849, nil, "Tank", nil, 5)
