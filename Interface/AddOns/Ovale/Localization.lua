...
L["Long cooldown abilities"] = "Fähigkeit mit langer Abklingzeit" -- Needs review
L["main"] = "Hauptangriff"
L["Main attack"] = "Hauptangriff" -- Needs review
L["mana"] = "Managewinn"
...
L["Click to select the script."] = "Клик для выбора скрипта" -- Needs review
...
L["Flash brightness"] = "Яркость подсветки" -- Needs review
L["Flash size"] = "Размер подсветки" -- Needs review
L["Flash spells"] = "Подсветка умения"
L["Flash spells on action bars when they are ready to be cast. Requires SpellFlashCore"] = "Подсвечивать способности, на панели умений, когда они готовы. Требуется SpellFlashCore" -- Needs review
L["Flash threshold"] = "Преддверие вспышкой" -- Needs review
L["Focus"] = "Фокус"
...
L["Interrupts"] = "Прерывания" -- Needs review
...
L["Long cooldown abilities"] = "Способности с большим кулдауном" -- Needs review
L["main"] = "Основная атака"
L["Main attack"] = "Основная атака" -- Needs review
...
L["Right-Click for options."] = "Правая кнопка для настроек" -- Needs review
L["Script"] = "Скрипт"
...
L["Short cooldown abilities"] = "Способности с малым временем восстановления" -- Needs review
L["Show hidden"] = "показать скрытые скрипты"
L["Show minimap icon"] = "Показать иконку на миникарте" -- Needs review
...
L["Time (in milliseconds) to begin flashing the spell to use before it is ready."] = "Время (в миллисекундах) за которое, до готовности, способность подсветится." -- Needs review
...
L["Flash spells"] = "法术闪动" -- Needs review
-- L["Flash spells on action bars when they are ready to be cast. Requires SpellFlashCore"] = ""
-- L["Flash threshold"] = ""
L["Focus"] = "焦点"
...
L["shortcd"] = [=[短冷却技能.
尽早施放.]=]
L["Short cooldown abilities"] = "短冷却技能" -- Needs review
-- L["Show hidden"] = ""
-- L["Show minimap icon"] = ""
