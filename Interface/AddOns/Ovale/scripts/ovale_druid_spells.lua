...
Define(dream_of_cenarius_tank_buff 145162)
	SpellInfo(dream_of_cenarius_tank_buff duration=40)
...
Define(ferocious_bite 22568)
	...
	SpellRequire(ferocious_bite energy -25=buff,omen_of_clarity_melee_buff if_spell=omen_of_clarity_melee itemset=T18 itemcount=4 specialization=feral)
...
SpellList(glyph_of_savage_roar_buff incarnation_king_of_the_jungle_buff prowl_buff)
...
Define(incarnation_king_of_the_jungle_talent 11)
...
SpellList(mangle_no_cooldown_buff berserk_bear_buff incarnation_son_of_ursoc_buff)
...
Define(ursa_major_buff 159233)
	SpellInfo(ursa_major_buff duration=15)
