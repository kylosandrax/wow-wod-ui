...
Define(lava_burst 51505)
	...
	SpellRequire(lava_burst cd 0=buff,echo_of_the_elements_buff if_spell=echo_of_the_elements)
	SpellRequire(lava_burst cd 0=buff,unleash_flame_buff if_spell=unleash_flame)
