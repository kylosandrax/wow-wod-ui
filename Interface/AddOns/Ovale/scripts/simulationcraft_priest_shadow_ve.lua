...
do
	local name = "SimulationCraft: Priest_Shadow_T17M_VE"
	local desc = "[6.0] SimulationCraft: Priest_Shadow_T17M_VE"
	local code = [[
# Based on SimulationCraft profile "Priest_Shadow_T17M_VE".
#	class=priest
#	spec=shadow
#	talents=1133132
