...
Define(berserker_rage 18499)
	SpellInfo(berserker_rage cd=30 gcd=0)
...
Define(colossus_smash 167105)
	...
	SpellInfo(colossus_smash rage=-30 itemset=T17 itemcount=2)
...
Define(execute 5308)
	...
	SpellRequire(execute target_health_pct 100=buff,death_sentence_buff)
	SpellRequire(execute target_health_pct 100=buff,sudden_death_buff)
...
Define(execute_arms 163201)
	...
	SpellRequire(execute_arms target_health_pct 100=buff,death_sentence_buff)
	SpellRequire(execute_arms target_health_pct 100=buff,sudden_death_buff)
...
Define(raging_blow_buff 131116)
	SpellInfo(raging_blow_aura duration=12 max_stacks=2)
...
Define(sweeping_strikes 12328)
	SpellInfo(sweeping_strikes cd=10 rage=10)
