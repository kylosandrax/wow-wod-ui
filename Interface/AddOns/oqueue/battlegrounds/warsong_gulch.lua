...
local flags = { { x = 0.529, y = 0.907, name = "Horde flag room" },
                { x = 0.489, y = 0.139, name = "Alliance flag room" },
              } ;
local graveyards = { { x = 0.580, y = 0.742, name = "Horde" },
                     { x = 0.420, y = 0.294, name = "Alliance" },
                   } ;
...
oq._bg_checks["WSG"] = { check   = wsg_utimer_check, 
                         close   = wsg_close,
                         loc     = wsg_get_current_loc,
                         shuffle = wsg_shuffle,
                         start   = wsg_start,
                         test    = wsg_test
                       } ;
