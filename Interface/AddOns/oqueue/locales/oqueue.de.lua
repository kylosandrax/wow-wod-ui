...
OQ.ANNOUNCE_CONTRACTS = "Sage VertrÃ¤ge an" ;
OQ.SETUP_SHOUTCONTRACTS = "Sage VertrÃ¤ge an" ;
...
OQ.SETUP_SAYSAPPED = "SAPs ansagen" ;
...
OQ.SETUP_SHOUTADS = "VerkÃ¼nde Premades" ; -- "Premades ansagen" ;
