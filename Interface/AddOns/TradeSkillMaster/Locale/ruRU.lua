...
L["Account Syncing"] = "Синхранизация аккаунта" -- Needs review
L["Active Developers:"] = "Активные разработчики:" -- Needs review
...
L["Alarm Clock"] = "Будильник" -- Needs review
...
L["Allows you to build a queue of crafts that will produce a profitable, see what materials you need to obtain, and actually craft the items."] = "Позволяет выстраивать очередь крафта, приносящего прибыль, видеть необходимые для крафта материалы и, собственно, крафтить." -- Needs review
L["Allows you to quickly and easily empty your mailbox as well as automatically send items to other characters with the single click of a button."] = "Позволяет быстро проверить почту, а так же автоматически отправить предметы другим персонажам в один клик." -- Needs review
...
L["Appearance"] = "Внешний вид" -- Needs review
L["Appearance Data"] = "Внешний вид данных" -- Needs review
L["Appearance Settings"] = "Настройки внешнего вида" -- Needs review
...
L["Are you sure you want to delete this group?"] = "Вы действительно хотите удалить эту группу?" -- Needs review
L["Are you sure you want to delete this operation?"] = "Вы действительно хотите удалить эту операцию?" -- Needs review
...
L["Auction Buys"] = "Цена выкупа" -- Needs review
...
L["Auction Window Close"] = "Закрыть окно аукциона" -- Needs review
L["Auction Window Open"] = "Открыть окно аукциона" -- Needs review
L["Auto Quest Complete"] = "Автоквест завершен" -- Needs review
L["Bags"] = "Сумки" -- Needs review
L["Bank"] = "Банк" -- Needs review
L["BankUI"] = "BankUI"
L["BankUI Move Delay"] = "Задержка перемещения BankUI " -- Needs review
L["BankUI Settings"] = "Настройки BankUI " -- Needs review
...
L["Cancelled - Bags and Bank / Guild Vault are full"] = "Отменено - сумки и банк / гильдейский банк полны" -- Needs review
L["Cancelled - Bags are full"] = "Отмена - Сумки заполнены"
L["Cancelled - Bank / Guild Vault is full"] = "Отменено - банк / гильдейский банк полны" -- Needs review
L["Cancelled - You must be at a bank or GuildVault"] = "Отменено - Вы должны быть в банке или гильдейском банке" -- Needs review
L["Cash Register"] = "Сумма зарегистрированна" -- Needs review
...
L["Chat Tab"] = "Вкладка чата" -- Needs review
...
L["Clean Bags Automatically"] = "Сумки оцищены автоматически" -- Needs review
L["Clean Bank Automatically"] = "Банк очищен автоматически" -- Needs review
L["Clean Reagent Bank Automatically"] = "Банк реагентов очищен автоатически" -- Needs review
L["Clear"] = "Очистить"
...
L["Coins (%s)"] = "Монет (%s)" -- Needs review
-- L["Connected to %s"] = ""
-- L["Connecting to %s..."] = ""
...
L["Create New Operation"] = "Создать новую Операцию" -- Needs review
...
L["Empty parentheses are not allowed"] = "Пустые скобки не допускаются" -- Needs review
L["Empty price string."] = "Пустая строка цены."
-- L["Enable Auction Buys Feature"] = ""
-- L["Enable Auction Sales Feature"] = ""
L["Enable Sound"] = "Включить звук" -- Needs review
...
L["Exploration"] = "Исследование" -- Needs review
...
L["Group Management"] = "Менеджер Групп" -- Needs review
...
L["Ignore Guilds"] = "Игнорировать гильдии" -- Needs review
...
L["Info"] = "Информация" -- Needs review
...
L["Just incase you didn't read this the first time:"] = "На случай, если вы не прочли это в первый раз:" -- Needs review
...
L["Known Characters: "] = "Известные персонажи:" -- Needs review
L["Label Text - Disabled"] = "Label Text - Отключен"
L["Label Text - Enabled"] = "Label Text - Разрешен"
L["Level Up"] = "Новый уровень" -- Needs review
...
L["Macro Setup"] = "Настройки макросов" -- Needs review
...
L["No Sound"] = "Без звука" -- Needs review
-- L["Offline"] = ""
