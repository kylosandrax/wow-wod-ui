...
Durch mehrmaliges Betätigen lässt sich die Start-Animation sehen.]=]
...
Es gibt drei Auslöser-Typen, die |cFFFF0000Auto-Klonen|r unterstützen: Voll-Scan Auren, Gruppen-Auren, and Multi-Ziel-Auren.]=]
L["Beginners Finished Text"] = [=[Hiermit ist die Einführung abgeschlossen. Allerdings hast du gerade mal an der Oberfläche der Möglichkeiten von |cFF8800FFWeakAuras|r gekratzt.
...
L["Create a Display: 4/5"] = "Eine Anzeige erzeugen: 4/5"
L["Create a Display: 5/5"] = "Eine Anzeige erzeugen: 5/5"
...
Du kannst deine Anzeige einfach anklicken und irgendwo auf deinen Bildschirm ziehen, und ihre Ecken anklicken und daran ziehen, um die Größe zu verändern.

Ebenso kannst du Shift drücken, um den Bewegungs- Größeneinstellungsrahmen für eine genauere Positionierung zu verstecken.]=]
L["Display Options: 1/4"] = "Anzeige-Einstellungen: 1/4"
L["Display Options 1/4 Text"] = "Wähle jetzt eine Fortschrittsbalken-Anzeige aus (oder lege eine neue an)."
L["Display Options: 2/4"] = "Anzeige-Einstellungen: 2/4"
L["Display Options 2/4 Text"] = [=[|cFFFFFFFFFortschrittsbalken-|r und |cFFFFFFFFSymbol-Anzeigen|r haben nun die Option, Tooltips beim Darüberhalten der Maus anzuzeigen.
...
Wähle \"Kreisförmig\" um sie im Einsatz zu sehen.]=]
L["Dynamic Group Options: 3/4"] = "Dynamische Gruppen Einstellungen: 3/4"
L["Dynamic Group Options 3/4 Text"] = [=[Die Einstellung des konstanten Faktor ermöglicht dir die Kontrolle darüber, wie deine kreisförmige Gruppe wächst.

Eine kreisförmige Gruppe mit konstantem Abstand gewinnt an Radius je mehr Anzeigen hinzugefügt werden, während ein konstanter Radius dazu führt, dass Anzeigen näher aneinander rücken, je mehr hinzugefügt werden.]=]
L["Dynamic Group Options: 4/4"] = "Dynamische Gruppen Einstellungen: 4/4"
...
Dies sorgt dafür, dass für jeden entsprechenden Parameter eine neue Anzeige angelegt wird.]=]
L["Full-scan Auras: 4/10"] = "Komplett gescannte Auren: 4/10"
...
Auslöser für Mehrfachziel-Auren unterscheiden sich dadurch von normalen Aura-Auslösern, dass sie auf Kampflog Ereignisse reagieren, was heißt, dass sie durch Auren auf Gegnern ausgelöst werden, die niemand als Ziel hat (obwohl gewisse dynamische Informationen nicht verfügbar sind, solange niemand in deiner Gruppe den Gegner als Ziel hat).
...
Diese Einführung wird dir zeigen, wie WeakAuras genutzt werden kann und dabei grundlegende Einstellungen erläutern.]=]
