...
L["%s - 1. Trigger"] = "%s - 1. Auslöser" -- Needs review
-- L["%s Alpha Animation"] = ""
L["Say"] = "Sagen"
-- L["%s Color Animation"] = ""
...
L["Show"] = "Zeigen"
L["Show Code"] = "Code zeigen" -- Needs review
L["Shrink"] = "Schrumpfen"
-- L["%s Icon Function"] = ""
-- L["%s - Init Action"] = ""
-- L["%s - %i. Trigger"] = ""
...
L["Up"] = "Hoch"
L["Version error received higher"] = "Diese Anzeige ist inkompatibel zu deiner WeakAuras-Version. Sie wurde mit der Version %s erstellt, du verwendest jedoch die Version %s. Bitte aktualisiere WeakAuras." -- Needs review
L["Version error received lower"] = "Diese Anzeige ist inkompatibel zu deiner WeakAuras-Version. Sie wurde mit der Version %s erstellt, du verwendest jedoch die Version %s. Bitte lass die andere Person WeakAuras aktualisieren." -- Needs review
