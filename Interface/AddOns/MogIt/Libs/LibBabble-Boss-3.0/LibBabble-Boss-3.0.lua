...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 434 $"):match("%d+"))
...
elseif GAME_LOCALE == "deDE" then
	...
	["Gri'lek"] = "Gri'lek",
	Grimlok = "Grimlok",
	["Grimrail Enforcers"] = "Überwacher des Grimmgleises", -- Needs review
	Grizzle = "Grizzle",
	Grobbulus = "Grobbulus",
	Grubbis = "Grubbis",
	Gruul = "Gruul",
...
elseif GAME_LOCALE == "koKR" then
	...
	["Admiral Gar'an"] = "제독 가란", -- Needs review
	["Admiral Ripsnarl"] = "제독 으르렁니",
	Aeonus = "아에누스",
	["Aerial Command Unit"] = "공중 지휘기",
	["Agathelos the Raging"] = "흉포한 아가테로스",
	["Aggem Thorncurse"] = "저주의가시 아겜",
	["Ahri'ok Dugru"] = "아리오크 두그루", -- Needs review
	Ahune = "아훈",
	["Akil'zon"] = "아킬존",
	["Aknor Steelbringer"] = "아크놀 스틸브링어", -- Needs review
	["Aku'mai"] = "아쿠마이",
	["Al'Akir"] = "알아키르",
	["Al'ar"] = "알라르",
	...
	["Ancient Protectors"] = "고대 수호자", -- Needs review
	...
	["Archmage Sol"] = "대마법사 솔", -- Needs review
	Arcurion = "아큐리온",
	Argaloth = "아르갈로스",
	...
	["Bazil Thredd"] = "바질 스레드",
	Bazzalan = "바잘란",
	["Beastlord Darmac"] = "야수군주 다르마크", -- Needs review
	Beauty = "아름이",
	["Beth'tilac"] = "베스틸락",
	["Black Guard Swordsmith"] = "검은호위대 검제작자",
	Blackhand = "블랙핸드", -- Needs review
	["Blackheart the Inciter"] = "선동자 검은심장",
	["Blade Lord Ta'yak"] = "칼날군주 타야크",
	["Blademaster Jubei'thos"] = "검귀 쥬베이토스", -- Needs review
	...
	Boahn = "보안",
	["Bomb Bot"] = "폭탄로봇",
	Bonemaw = "해골아귀", -- Needs review
	["Borka the Brute"] = "육중한 보르카", -- Needs review
	Brackenspore = "담쟁이포자", -- Needs review
	...
	["Commander Tharbek"] = "사령관 탈베크", -- Needs review
	...
	["Dia Darkwhisper"] = "디아 다크위스퍼", -- Needs review
	...
	Dreadfang = "공포송곳니", -- Needs review
	Dreadscale = "공포비늘",
	Dreadwing = "공포날개", -- Needs review
	Dreamscythe = "드림사이드",
	["Drov the Ruiner"] = "파괴의 현신 드로브", -- Needs review
	Dulhu = "둘후", -- Needs review
	...
	["Earthshaper Telu"] = "대지창조자 텔루", -- Needs review
	Ebonroc = "에본로크",
	...
	["Enforcer Sorka"] = "집행자 소르카", -- Needs review
	Entropius = "엔트로피우스",
	...
	Faultline = "지진발굽", -- Needs review
	["Fel Lord Zakuun"] = "지옥 군주 자쿠운", -- Needs review
	Felmyst = "지옥안개",
	Feludius = "펠루디우스",
	...
	["Flamebender Ka'graz"] = "화염칼날 카그라즈", -- Needs review
	Flamegor = "플레임고르",
	["Flame Leviathan"] = "거대 화염전차",
	["Flameweaver Koegler"] = "화염술사 쾨글러",
	["Fleshrender Nok'gar"] = "살점분리자 녹가르", -- Needs review
	["Foe Reaper 5000"] = "전투 절단기 5000",
	["Foreman Feldspar"] = "현장감독 펠드스파", -- Needs review
	["Foreman Thistlenettle"] = "현장감독 시슬네틀",
	["Forgemaster Garfrost"] = "괴철로감독관 가프로스트",
	["Forgemaster Gog'duh"] = "제련장인 고그더", -- Needs review
	["Forgemaster Throngus"] = "제련장인 트롱구스",
	["Four Horsemen Chest"] = "Four Horsemen Chest",
	Franzok = "프란조크", -- Needs review
	["Fras Siabi"] = "프라스 샤비",
	Freya = "프레이야",
	...
	["Gri'lek"] = "그리렉",
	Grimlok = "그림로크",
	["Grimrail Enforcers"] = "파멸철로 집행자", -- Needs review
	Grizzle = "그리즐",
	Grobbulus = "그라불루스",
	Grubbis = "그루비스 ",
	Gruul = "그룰", -- Needs review
	...
	Halycon = "할리콘",
	Hamhock = "햄혹",
	["Hans'gar"] = "한스가르", -- Needs review
	["Hans'gar and Franzok"] = "한스가르와 프란조크", -- Needs review
	...
	["Heart of the Mountain"] = "산의 정수", -- Needs review
	["Hedrum the Creeper"] = "왕거미 헤드룸",
	["Heigan the Unclean"] = "부정의 헤이건",
	["Helix Gearbreaker"] = "헬릭스 기어브레이커",
	["Hellfire Assault"] = "지옥불 공성전", -- Needs review
	["Hellfire Cannon"] = "지옥불 대포", -- Needs review
	["Hellfire Channeler"] = "지옥불 역술사",
	["Hellfire High Council"] = "지옥불 고위 의회", -- Needs review
	["Henry Stern"] = "헨리 스턴",
	...
	["High Sage Viryx"] = "대현자 비릭스", -- Needs review
	...
	["Immol'thar"] = "이몰타르",
	["Imperator Mar'gok"] = "높은군주 마르고크", -- Needs review
	...
	Ionar = "아이오나",
	Ironaya = "아이로나야",
	Ironcrusher = "강철파쇄자", -- Needs review
	["Iron Juggernaut"] = "강철의 거대괴수", -- Needs review
	["Iron Qon"] = "강철의 퀀",
	["Iron Reaver"] = "강철 절단기", -- Needs review
	Ironspine = "무쇠해골",
	Isalien = "이살리엔",
	Isiset = "이시세트",
	...
	Kalecgos = "칼렉고스",
	["Kam Deepfury"] = "캄 딥퓨리",
	["Kargath Bladefist"] = "카르가스 블레이드피스트", -- Needs review
	...
	["Kil'jaeden"] = "킬제덴",
	["Kil'rek"] = "킬렉",
	["Kilrogg Deadeye"] = "킬로그 데드아이", -- Needs review
	...
	["Life Warden Gola"] = "생명 감시자 골라", -- Needs review
	["Lilian Voss"] = "릴리안 보스",
	...
	["Makogg Emberblade"] = "잿불칼날 마코그", -- Needs review
	Malacrass = "말라크라스",
	...
	Malygos = "말리고스",
	Mannoroth = "만노로스",
	["Marak the Blooded"] = "피의 여전사 마라크", -- Needs review
	Maraudos = "마라우도스",
	...
	["Quet'zal"] = "쿠엣잘",
	["Ra-den"] = "라덴",
	["Ragewing the Untamed"] = "폭군 격노날개", -- Needs review
	["Rage Winterchill"] = "격노한 윈터칠",
	Ragglesnout = "너덜주둥이",
	["Raging Spirit"] = "분노한 영혼",
	Ragnaros = "라그나로스",
	Raigonn = "라이곤",
	["Railmaster Rocketspark"] = "철도관리인 로켓스파크", -- Needs review
	Rajh = "라지",
	["Ramstein the Gorger"] = "먹보 람스타인",
	["Randolph Moloch"] = "란돌프 몰로크",
	Ranjit = "란지트", -- Needs review
	...
	Rotface = "썩은얼굴",
	Rotgrip = "썩은 아귀",
	Rukhmar = "루크마르", -- Needs review
	Rukhran = "루크란", -- Needs review
	["Runemaster Molgeim"] = "룬술사 몰가임",
	["Runok Wildmane"] = "루노크 와일드메인",
	Ruuzlu = "루즐루",
	["Saboteur Kip'tilak"] = "파괴자 키프틸락",
	["Sadana Bloodfury"] = "새다나 블러드퓨리", -- Needs review
	...
	["Shadow-Lord Iskar"] = "그림자군주 이스카르", -- Needs review
	...
	["Siegemaster Mar'tak"] = "공성전문가 마르타크", -- Needs review
	Sindragosa = "신드라고사",
	Sinestra = "시네스트라",
	["Sir Zeliek"] = "젤리에크 경",
	...
	["Skra'gath"] = "스크라가스",
	Skul = "스컬",
	Skulloc = "스컬록", -- Needs review
	Skum = "스컴",
	["Skylord Tovra"] = "하늘군주 토브라", -- Needs review
	Slabhide = "돌거죽",
	["Slad'ran"] = "슬라드란",
	Slagmaw = "화산아귀", -- Needs review
	["Slave Watcher Crushto"] = "노예감시자 크러쉬토", -- Needs review
	Sneed = "스니드",
	["Sneed's Shredder"] = "스니드의 벌목기",
	["Socrethar the Eternal"] = "영원한 소크레타르", -- Needs review
	["Solakar Flamewreath"] = "화염고리 솔라카르",
	["Solarium Agent"] = "태양의 전당 요원",
	["Solarium Priest"] = "태양의 전당 사제",
	["Soulbinder Nyami"] = "영혼술사 니아미", -- Needs review
	...
	["Tarlna the Ageless"] = "영생의 탈르나", -- Needs review
	Tavarok = "타바로크",
	Techbot = "첨단로봇",
	Tectus = "텍터스", -- Needs review
	["Temple Guardian Anhuur"] = "사원 수호자 안후르",
	Temporus = "템퍼루스",
	["Tendris Warpwood"] = "굽이나무 텐드리스",
	Tenebron = "테네브론",
	["Terestian Illhoof"] = "테레스티안 일후프",
	["Teron'gor"] = "테론고르", -- Needs review
	...
	["The Blast Furnace"] = "격노의 가열로", -- Needs review
	["The Blue Brothers"] = "푸른 형제들",
	["The Bug Family"] = "벌레 무리",
	["The Butcher"] = "도살자", -- Needs review
	["The Crone"] = "마녀",
	["The Curator"] = "전시 관리인",
	...
	["The Iron Maidens"] = "강철의 여전사들", -- Needs review
	...
	["Twin Ogron"] = "쌍둥이 오그론", -- Needs review
	["Tyrant Velhari"] = "폭군 벨하리", -- Needs review
	Ultraxion = "울트락시온",
	...
	["Vigilant Kaathar"] = "수호자 카타르", -- Needs review
	["Vile'rel"] = "타락의 문지기",
	Viscidus = "비시디우스",
	...
	["Warlord Zaela"] = "전쟁군주 잴라", -- Needs review
