...
L["Search"] = true
L["Select a Crafter"] = true
L["Selected Sources"] = true
L["Select one of your characters' professions to browse."] = true
L["Select one or more Professions"] = true
...
L["This toggles the display of the options frame."] = true
